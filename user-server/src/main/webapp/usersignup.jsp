    ...
    <div class="form-wrapper">
      <form action="/successSignUp" method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control formInput" id="userName" name="uname" placeholder="Enter your Name" autocomplete="false" required />
        </div>
        <small>We will generate an User Id for you!</small> <br><br>
        <!-- <div class="form-group">
          <label class="formLabel" for="userId">User Id</label>
          <input type="text" class="form-control formInput" id="userId" name="uid" placeholder="Enter a User Id" autocomplete="false" type="number" required />
        </div> -->
        <div class="form-group">
      ...
      <div class="text-center">
      	Already a User? Click below button to Login!
      	<br />
      	<br />
